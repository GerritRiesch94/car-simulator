...
${OBJECTDIR}/_ext/89df9ec6/start_arguments.o: /home/andi/Projekt/car-simulator/src/start_arguments.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/lua5.2 -ISelene/include `pkg-config --cflags lua-5.2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/89df9ec6/start_arguments.o /home/andi/Projekt/car-simulator/src/start_arguments.cpp
...
${OBJECTDIR}/_ext/89df9ec6/start_arguments_nomain.o: ${OBJECTDIR}/_ext/89df9ec6/start_arguments.o /home/andi/Projekt/car-simulator/src/start_arguments.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I/usr/include/lua5.2 -ISelene/include `pkg-config --cflags lua-5.2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/89df9ec6/start_arguments_nomain.o /home/andi/Projekt/car-simulator/src/start_arguments.cpp;\
	else  \
