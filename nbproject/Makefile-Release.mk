...
${OBJECTDIR}/src/start_arguments.o: src/start_arguments.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/lua5.2 -ISelene/include `pkg-config --cflags lua-5.2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/start_arguments.o src/start_arguments.cpp
...
${OBJECTDIR}/src/start_arguments_nomain.o: ${OBJECTDIR}/src/start_arguments.o src/start_arguments.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I/usr/include/lua5.2 -ISelene/include `pkg-config --cflags lua-5.2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/start_arguments_nomain.o src/start_arguments.cpp;\
	else  \
